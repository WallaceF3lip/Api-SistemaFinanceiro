...
namespace Infra.Configuracao
{
    public class ContextBase : IdentityDbContext<ApplicationUser>
    {
        ...
        {
             return "Data Source=NBQSP-FC693;Initial Catalog=FINANCEIRO_2023;Integrated Security=False;User ID=sa;Password=[SENHA_DO_BANCO];Connect Timeout=15;Encrypt=False;TrustServerCertificate=False";
        }
